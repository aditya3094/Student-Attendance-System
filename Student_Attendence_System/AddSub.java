...
public class AddSub extends JFrame {
	AddSub(){
		...
		String s[]= {"CSE","CSE (Data science)","CSE (AIML)","Civil","Mech"};
		...
		l16.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==l16) {
					try {
						File f1=new File("C:\\Users\\HP\\Desktop\\project\\Attendance_System\\Attendance-Management-System-master\\SubjectList.txt");
