...
public class Attend2 extends JFrame{
	...
	Attend2(){
		...
		try {
			File f1=new File("C:\\Users\\HP\\Desktop\\project\\Attendance_System\\Attendance-Management-System-master\\Attend1.txt");
        ...
        q5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==q5) {
					...
					for(int i=0;i<rcnt;i++) {
        				try {
        					File f2=new File("C:\\Users\\HP\\Desktop\\project\\Attendance_System\\Attendance-Management-System-master\\Attend2.txt");
