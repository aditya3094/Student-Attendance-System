...
public class Attend1 extends JFrame implements ActionListener{
	Attend1(){
		...
		try {
			File f3=new File("C:\\Users\\HP\\Desktop\\project\\Attendance_System\\Attendance-Management-System-master\\Attend1.txt");
		...
		String s[]= {"CSE","CSE (Data Science)","CSE (AIML0","Civil","Mech"};
		...
		l6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==l6) {
					try {
						File f1=new File("C:\\Users\\HP\\Desktop\\project\\Attendance_System\\Attendance-Management-System-master\\StudentList.txt");
						...
						while(rd.hasNextLine()) {
							...
							if(x1.equals((String)l2.getSelectedItem()) && x2.equals((String)l4.getSelectedItem()) && x3.equals(l8.getText())) {
								File f2=new File("C:\\Users\\HP\\Desktop\\project\\Attendance_System\\Attendance-Management-System-master\\Attend1.txt");
